...
const CF_SOLVER_URL  = process.env.CF_SOLVER_URL           || 'https://cf-clearance-scraper-znty.onrender.com/cf-clearance-scraper';
...
const TOKEN_TTL_MS     = parseInt(process.env.TOKEN_TTL_MS    || '240', 10);
